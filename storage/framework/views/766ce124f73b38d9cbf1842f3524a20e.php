            ...
            <div class="modal-body">
                <form id="updateUserForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="username" class="form-control" value="<?php echo e($user->username); ?>" required placeholder="Enter username">
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" id="email" class="form-control" value="<?php echo e($user->email); ?>" required placeholder="Enter email">
                    </div>
                </form>
            </div>
...
<script>
    ...
    function submitUpdateUser() {
        ...
        formData.append('_token', '<?php echo e(csrf_token()); ?>');  // CSRF token for security

        // Send AJAX request to update the user
        fetch('<?php echo e(route("user.update-user", ":id")); ?>'.replace(':id', <?php echo e($user->id); ?>), {
            method: 'POST',
            body: formData,
        })
...
<?php /**PATH C:\Users\DPK\secure-auth-system\secure-auth-system\resources\views/users/update-user.blade.php ENDPATH**/ ?>