...
<div class="container">
    ...
    <form action="<?php echo e(route('user.remove-role', $user->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\DPK\secure-auth-system\secure-auth-system\resources\views/users/remove-role.blade.php ENDPATH**/ ?>